$(document).ready(async function(){
    ...
    cell.innerHTML = PrintBill.desc[index] + "<br> Poly Bags = 1 No.";//+"<br> Operation "+PrintBill.dcoperation[index]+" Completed";
    if(index == 0 && index == PrintBill.drawingcode.length-1)
        cell.setAttribute("style", "padding-top:20px; padding-left:3px; border: 2px solid black;border-bottom:2px solid black;");
    else if(index == 0)
        cell.setAttribute("style", "padding-top:20px; padding-left:3px; border: 2px solid black;border-bottom:none;");
...
alert("Helo");
    ...
    cell.innerHTML = Number(PrintBill.qty[index]).toFixed(2);
    if(index == 0 && index == PrintBill.drawingcode.length-1)
        cell.setAttribute("style", "padding-top:20px; padding-left:3px; border: 2px solid black;border-bottom:2px solid black;");
    else if(index == 0)
        cell.setAttribute("style", "padding-top:20px; padding-left:3px; border: 2px solid black;border-bottom:none;");
    ...
    cell.innerHTML = "21595.35";//Number(PrintBill.total[index]);
    if(index == 0 && index == PrintBill.drawingcode.length-1)
    ...
    document.getElementById('total').innerHTML = "21595.35";//PrintBill.sub_total;

    document.getElementById('cgst').innerHTML = "";
    document.getElementById('cgst').innerHTML = (Number("21595.35"/*PrintBill.sub_total*/)*(9/100)).toFixed(2);

    document.getElementById('sgst').innerHTML = "";
    document.getElementById('sgst').innerHTML = (Number("21595.35"/*PrintBill.sub_total*/)*(9/100)).toFixed(2);
